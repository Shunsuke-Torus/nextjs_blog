...
## 1 実験環境
<image width="325" alt="実験画像" src="./../public/images/ospf1.jpg">

#### 図1:実際に構築の際に用いた図
図１をCiscoパケットトレーサーで再現し以下に示す。

<image width="325" alt="Ciscoのパケットトレーサーで再現したospfの設計画像" src="./../public/images/ospf2.jpg">
...
---
* 実験4   
    ④が何らかの理由によって、切断されてしまったとき、PC1からPC3へtracertコマンドを入力すると、どのような経路で接続されているの。 
...
---
* 実験5  
      RT2にて、show ip ospf databaseコマンドを実行すると、どのように表示されるの。 
